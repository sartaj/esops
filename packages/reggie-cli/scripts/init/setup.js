...
module.exports = function setup (appPath, appName, options) {
  ...
  const flavorPath = path.join(appPath, 'node_modules', 'reggie-cli')
  ...
  // Copy reggie-cli/template/gitgnore to ./.gitignore
